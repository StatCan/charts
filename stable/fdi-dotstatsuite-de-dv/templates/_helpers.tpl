...
Create the name of the service account to use
*/}}
{{- define "dotstatsuite.dexplorer.serviceAccountName" -}}
{{- if .Values.dexplorer.serviceAccount.create }}
{{- default (include "dotstatsuite.fullname" .) .Values.dexplorer.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.dexplorer.serviceAccount.name }}
{{- end }}
{{- end }}
...
Create the name of the service account to use
*/}}
{{- define "dotstatsuite.dataview.serviceAccountName" -}}
{{- if .Values.dataview.serviceAccount.create }}
{{- default (include "dotstatsuite.fullname" .) .Values.dataview.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.dataview.serviceAccount.name }}
{{- end }}
{{- end }}
