...
def prepare_configset(cfset_name):
    ...
    check_file_exists(shutil.copytree, "/srv/solr-configset", "/srv/app/solr-configset")
    #os.chmod("/srv/app/solr-configset",777)
    subprocess.call(['chmod', '-R', '+w', '/srv/app/solr-configset'])
    ...
    shutil.make_archive('/srv/app/temp_configset', 'zip', '/srv/app/solr-configset')
